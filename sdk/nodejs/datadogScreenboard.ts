...
export class DatadogScreenboard extends pulumi.CustomResource {
    /**
     * Get an existing DatadogScreenboard resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DatadogScreenboardState, opts?: pulumi.CustomResourceOptions): DatadogScreenboard {
        return new DatadogScreenboard(name, <any>state, { ...opts, id: id });
    }
    ...
    /**
     * Create a DatadogScreenboard resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DatadogScreenboardArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DatadogScreenboardArgs | DatadogScreenboardState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state: DatadogScreenboardState = argsOrState as DatadogScreenboardState | undefined;
            ...
            const args = argsOrState as DatadogScreenboardArgs | undefined;
        ...
        super("datadog:index/datadogScreenboard:DatadogScreenboard", name, inputs, opts);
    }
}
 ...
 */
export interface DatadogScreenboardState {
    /**
     * Height of the screenboard
     */
 ...
 */
export interface DatadogScreenboardArgs {
    /**
     * Height of the screenboard
     */
    readonly height?: pulumi.Input<string>;
