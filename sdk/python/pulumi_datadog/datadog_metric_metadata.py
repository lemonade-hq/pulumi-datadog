...
class DatadogMetricMetadata(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, description=None, metric=None, per_unit=None, short_name=None, statsd_interval=None, type=None, unit=None, __name__=None, __opts__=None):
        ...
        super(DatadogMetricMetadata, __self__).__init__(
            'datadog:index/datadogMetricMetadata:DatadogMetricMetadata',
            resource_name,
            __props__,
            opts)
